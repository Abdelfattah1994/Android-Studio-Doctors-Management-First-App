...
public class DoctorAdapter extends RecyclerView.Adapter<DoctorAdapter.DoctorViewHolder>  implements Filterable {
    ...
    private List<Doctor> doctorsFilter;
    ...
    public DoctorAdapter(Context context, List<Doctor> doctors) {
        ...
        doctorsFilter.addAll(doctors);
        mfilter = new NewFilter(this);
    }
    @NonNull
    @Override
    public DoctorViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(this.context).inflate(R.layout.doctor_item,
                viewGroup, false);
        final DoctorViewHolder holder = new DoctorViewHolder(v);
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                View popup = LayoutInflater.from(context).inflate(R.layout.doctor_edit_item, null,
                        false);
                ...
                AlertDialog dialog = new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Valider", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Doctor doctor = DoctorService.getInstance().findById(ids);
                                doctor.setStar(s);
                                DoctorService.getInstance().update(doctor);
    ...
    public class NewFilter extends Filter {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            doctorsFilter = (List<Doctor>) filterResults.values;
